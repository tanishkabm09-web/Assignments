...
public class ResultDeclaration {
    ...
    /*
    The declare result() method waits until another thread calls notify(). Duri ng wait(), the thread releases the lock, allowing other threads to enter the synchronized code.
        ℹ️ points to remember
         ...
         ☑️Order-Placed -> Preparing -> Delivering -> Delivered
