...
/*
Code Explanation:
The synchronized keyword ensures that only oe tread can execute the withdraw() operation at a time, preventing RACE CONDITION and ensuring correct balance deduction
ℹ️Points to Remember
⭐Synchronization avoids RACE CONDITION
⭐Locks critical section in an application
⭐Slower but safe
⭐Essential for shared resourses
 */
