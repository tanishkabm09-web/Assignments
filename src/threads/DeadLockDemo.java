...
Account A &Thread-2 waits for Account B. Since neither thread releases the lock. Both keep waiting & thus creating a DEADLOCK ❌🔒
DEADLOCK Explanation : Deadlock occurs when each  thread is holding a resource & waiting for other to release it.
 */